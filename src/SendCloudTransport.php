...
{
    const SEND_HTML_URL     = 'https://api.sendcloud.net/apiv2/mail/send';
    const SEND_TEMPLATE_URL = 'https://api.sendcloud.net/apiv2/mail/sendtemplate';
